...
public class PhoneRegisterActivity extends AppCompatActivity implements
    ...
    public void onStart() {
        ...
        if (mVerificationInProgress && validatePhoneNumber()) {
            startPhoneNumberVerification("+91" + mPhoneNumberField.getEditText().getText().toString());
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            final String phoneNumber = "+91" + mPhoneNumberField.getEditText().getText().toString();
    ...
    private boolean validatePhoneNumber() {
        ...
        String phoneNumber = "+91" + mPhoneNumberField.getEditText().getText().toString();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonResend:
                resendVerificationCode("+91" + mPhoneNumberField.getEditText().getText().toString(), mResendToken);
                break;
        }
    }
}